        ...
        <div class="card">
          <div class="card-body">
            ...
            <form method="post" action="{{ route('update.slide') }}" enctype="multipart/form-data">
              ...
              <div class="row mb-3">
                <label for="example-text-input" class="col-sm-2 col-form-label">Vide URL</label>
                <div class="col-sm-10">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <img id="showImage" class="rounded avatar-lg" src="{{ (!empty($homeslide->home_slide)) ? url($homeslide->home_slide) : url('uploads/no_image.jpg')}}" alt="Card image cap">
                </div>
              </div>
              <!-- end row -->
